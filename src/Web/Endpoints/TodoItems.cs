using MSAFocus_TechnicalAssessment.Application.Common.Models;
using MSAFocus_TechnicalAssessment.Application.TodoItems.Commands.CreateTodoItem;
using MSAFocus_TechnicalAssessment.Application.TodoItems.Commands.DeleteTodoItem;
using MSAFocus_TechnicalAssessment.Application.TodoItems.Commands.UpdateTodoItem;
using MSAFocus_TechnicalAssessment.Application.TodoItems.Commands.UpdateTodoItemDetail;
using MSAFocus_TechnicalAssessment.Application.TodoItems.Queries.GetTodoItemsWithPagination;
using Microsoft.AspNetCore.Http.HttpResults;

namespace MSAFocus_TechnicalAssessment.Web.Endpoints;
